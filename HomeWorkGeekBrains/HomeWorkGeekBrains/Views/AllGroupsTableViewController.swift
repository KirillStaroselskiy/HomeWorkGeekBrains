...
class AllGroupsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        allGroups = [GroupModal(name: "GeelBrains", icon: "geekbrains"),
                      GroupModal(name: "HabrHabr", icon: "habrhabr"),
                      GroupModal(name: "Фильмы", icon: "geekbrains"),
                      GroupModal(name: "Мозг", icon: "habrhabr"),
                      GroupModal(name: "Купи продай", icon: "geekbrains"),
                      GroupModal(name: "Камеди клаб", icon: "habrhabr"),
